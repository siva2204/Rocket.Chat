...
console.log('CWD after uplink-nodejs import', process.cwd());
// changing dir to initial
...
const storjConfig = {
	apiKey: '1Fkab3PcXARviuFNngaLBjhmjMVQ1icigoz3sbjmuqfFE1ZJyDA3tzgNmKmyqiFE1LCzSDG6r86XYF6aU5xTUvnNoNgiavT7TCnawrt7mRe8XRb8mTZbtQYvUqvSEDLDruFLuUiDcStBh8Ez7bSvR',
	satelliteURL: '121RTSDpyNZVcEU84Ticf2L1ntiuUimbWgfATz21tuvgk3vzoA6@asia-east-1.tardigrade.io:7777',
	encryptionPassphrase: 'hello world welcome home :p',
	bucketName: '',// bucket name
	uploadPath: 'upload',// upload object name
};
var localFullFileName = {
    src :'', // enter file path from root i.e / for upload
